...
const REQUIREMENT_PATH = join(__dirname, '..', 'data', 'requirements', 'REQ-SALES-005.json');
...
const SCORE_THRESHOLD = Number(PRIMARY_CONDITION?.value ?? 35);
...
/**
 * Executes REQ-SALES-005 when lead score is updated.
 * Actions driven by approved structured_actions from REQ-SALES-005.json.
 * Triggers when lead_score <= 35 (low-score lead needing follow-up).
 */
export function onLeadScoreUpdatedSales005(lead, previousScore) {
...
export const RULE_CONFIG_SALES_005 = {
  requirement_id: REQUIREMENT_ID,
