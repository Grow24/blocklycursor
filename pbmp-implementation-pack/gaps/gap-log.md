...
| GAP-REQ-SALES-001-04 | REQ-SALES-001 | Missing Business Rule | Requirement text and approved design were clarified to execute the rule whenever a lead score update satisfies `lead_score > 80` (no extra threshold-crossing rule). | Resolved | Development | Business Analyst |
