...
| 2 | Check lead_score <= 35 | REQ-SALES-005.condition |
| 3 | Create follow-up task "Follow up with customer" | REQ-SALES-005.structured_actions[0] |
| 4 | Notify Product Manager: "High-score lead needs follow-up" | REQ-SALES-005.structured_actions[1] |
